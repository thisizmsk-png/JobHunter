#!/usr/bin/env python3
"""
Dice Easy Apply — Batch Q (1 job) for Vamsi M.
...
BATCH_FILE = PROJECT_ROOT / "data" / "batch_Q_jobs.json"

LOG_DIR.mkdir(parents=True, exist_ok=True)
log_file = LOG_DIR / f"dice_batchQ_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("Dice Easy Apply Batch Q -- 1 Job for Vamsi M")
    ...
    # Save results JSON
    results_file = LOG_DIR / "dice_batchQ_results.json"
